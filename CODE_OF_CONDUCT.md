...
We commit ourselves to a high standard of public behavior and
expect the same of participants on all project-related public
communication. We have one overarching rule:
...
Specifically, we aspire to these qualities:
  ...
  * In our communication, we consistently honor and affirm the passion,
  ...
  * Where we disagree with someone, we avoid forms of expression that might
  ...
  marginalized. Our critique should always be of specific statements and
  ...
  * We do not tolerate any form of discriminatory language or behavior
...
Our response should usually be to apologize and stop doing what it was that you
...
This code of conduct has been derived and adapted from the [Haskell
Foundation's Guidelines for Respectful
