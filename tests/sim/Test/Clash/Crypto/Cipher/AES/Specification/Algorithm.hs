...
tastyTests = testGroup "Clash.Crypto.Cipher.AES.Specification.Algorithm"
  [  testProperty "Test verify Spec.keyExpansionAES128 with Appendix A.1 FIPS 197" $ property $ do
        testKeyExpansionAES128, 
      testProperty "Test verify Spec.keyExpansionAES192 with Appendix A.2 FIPS 197" $ property $ do
        testKeyExpansionAES192, 
      testProperty "Test verify Spec.keyExpansionAES256 with Appendix A.3 FIPS 197" $ property $ do
...
testKeyExpansionAES128 = Spec.keyExpansion(Proxy @(Spec.AES128 ∷ Spec.AES)) key1AES128 === w1AES128

testCipherAES128 ∷ PropertyT IO ()
testCipherAES128 = Spec.cipher  (Proxy @(Spec.AES128 ∷ Spec.AES)) in1AES128 (Spec.keyExpansion (Proxy @(Spec.AES128 ∷ Spec.AES)) key1AES128) === out1AES128

testInvCipherAES128 ∷ PropertyT IO ()
testInvCipherAES128 = Spec.invCipher (Proxy @(Spec.AES128 ∷ Spec.AES))  out1AES128  w1AES128 === in1AES128


testInverseAES128 ∷ (Monad m) ⇒ InType Spec.AES128 → KeyType Spec.AES128 → PropertyT m ()
testInverseAES128 input key = input === Spec.invCipher (Proxy @(Spec.AES128 ∷ Spec.AES)) (Spec.cipher  (Proxy @(Spec.AES128 ∷ Spec.AES)) input (Spec.keyExpansion (Proxy @(Spec.AES128 ∷ Spec.AES)) key)) (Spec.keyExpansion (Proxy @(Spec.AES128 ∷ Spec.AES)) key)


testEquivalentAES128 ∷ (Monad m) ⇒ InType Spec.AES128 → KeyType Spec.AES128 → PropertyT m ()
testEquivalentAES128 input key = Spec.invCipher (Proxy @(Spec.AES128 ∷ Spec.AES))  input  (Spec.keyExpansion (Proxy @(Spec.AES128 ∷ Spec.AES)) key) ===  Spec.eqInvCipher (Proxy @(Spec.AES128 ∷ Spec.AES))  input  (Spec.keyExpansionIEC  (Proxy @(Spec.AES128 ∷ Spec.AES)) key)
--------------------------------------------------------------
-- AES192
--------------------------------------------------------------
...
testKeyExpansionAES192 = Spec.keyExpansion(Proxy @(Spec.AES192 :: Spec.AES)) key1AES192 === w1AES192

testInverseAES192 ∷ (Monad m) ⇒ InType Spec.AES192 → KeyType Spec.AES192 → PropertyT m ()
testInverseAES192 input key = input === Spec.invCipher (Proxy @(Spec.AES192 ∷ Spec.AES)) (Spec.cipher  (Proxy @(Spec.AES192 ∷ Spec.AES)) input (Spec.keyExpansion (Proxy @(Spec.AES192 ∷ Spec.AES)) key)) (Spec.keyExpansion (Proxy @(Spec.AES192 ∷ Spec.AES)) key)

testEquivalentAES192 ∷ (Monad m) ⇒ InType Spec.AES192 → KeyType Spec.AES192 → PropertyT m ()
testEquivalentAES192 input key = Spec.invCipher (Proxy @(Spec.AES192 ∷ Spec.AES))  input  (Spec.keyExpansion (Proxy @(Spec.AES192 ∷ Spec.AES)) key) ===  Spec.eqInvCipher (Proxy @(Spec.AES192 ∷ Spec.AES))  input  (Spec.keyExpansionIEC  (Proxy @(Spec.AES192 ∷ Spec.AES)) key)
--------------------------------------------------------------
-- AES256
--------------------------------------------------------------
...
testKeyExpansionAES256 = Spec.keyExpansion(Proxy @(Spec.AES256 :: Spec.AES)) key1AES256 === w1AES256

testInverseAES256 ∷ (Monad m) ⇒ InType Spec.AES256 → KeyType Spec.AES256 → PropertyT m ()
testInverseAES256 input key = input === Spec.invCipher (Proxy @(Spec.AES256 ∷ Spec.AES)) (Spec.cipher  (Proxy @(Spec.AES256 ∷ Spec.AES)) input (Spec.keyExpansion (Proxy @(Spec.AES256 ∷ Spec.AES)) key)) (Spec.keyExpansion (Proxy @(Spec.AES256 ∷ Spec.AES)) key)

testEquivalentAES256 ∷ (Monad m) ⇒ InType Spec.AES256 → KeyType Spec.AES256 → PropertyT m ()
testEquivalentAES256 input key = Spec.invCipher (Proxy @(Spec.AES256 ∷ Spec.AES))  input  (Spec.keyExpansion (Proxy @(Spec.AES256 ∷ Spec.AES)) key) ===  Spec.eqInvCipher (Proxy @(Spec.AES256 ∷ Spec.AES))  input  (Spec.keyExpansionIEC  (Proxy @(Spec.AES256 ∷ Spec.AES)) key)