...
import Hitl.Clash.Cores.LatticeSemi.ECP5.Domain (Dom48, Dom8)
import Hitl.Clash.Cores.LatticeSemi.ECP5.Pll (orangePll8)
...
topEntity ∷
  "CLK" ::: Clock Dom48 →
  "PMOD1_6" ::: Signal Dom8 Bit →
  "PMOD1_5" ::: Signal Dom8 Bit
topEntity (orangePll8 → (clk, rst))
