...
HITLT instance for 'Clash.Crypto.Calculator.InverseModulo.bea'.
-}
...
import Clash.Crypto.Calculator.InverseModulo (bea)
...
topEntity (orangePll12 → (clk, rst))
  ...
  $ newsfeed . bea @SecP256ModPrime . cachedFromMaybe . bulkRead
